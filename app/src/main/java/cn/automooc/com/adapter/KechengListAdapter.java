...
import cn.automooc.com.ui.TypeActivity;
...
//                }
    ...
    private void jumpToCourse(int i, int list_pos) {
        ConstantSet.course_id = lists.get(i).getItem().get(list_pos).getVal();
        ConstantSet.videoTitle = lists.get(i).getItem().get(list_pos).getTitle();
