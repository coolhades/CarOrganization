 ...
 */
public class PrefectureDetailCourseAdapter extends ListBaseAdapter{
    ...
    public PrefectureDetailCourseAdapter(Context mContext, List<PrefectureBean.DataBean.PgcCourseListBean.ListBean> lists) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (ConstantSet.confiMap != null) {
            if (ConstantSet.confiMap.get("App.Switch.Course.MaskInfo").equals("1")) {
                ...
                ((MyViewHolder) holder).teacherAndDate.setText(lists.get(position).getTeacher_name()
//                        + "/" + lists.get(position).getDate_start() + "-" + lists.get(position).getDate_end()
                );
            }
        }
...
//                }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            teacherAndDate= (TextView) itemView.findViewById(R.id.teachername_text);
        }
    }
