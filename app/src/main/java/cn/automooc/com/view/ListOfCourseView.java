...
import cn.automooc.com.adapter.FirstVideoView1ListViewAdapter;
...
public class ListOfCourseView {
    ...
    public ListOfCourseView(Context mContext, List<ZhangBean> zhangBean) {
