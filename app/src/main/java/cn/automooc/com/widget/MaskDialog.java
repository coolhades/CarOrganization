...
//    ProgressDialog dialog;
    ...
    public MaskDialog(Context context, String fileName, String key, String question) {
...
//        dialog.show();
    ...
    public void getData(final String fileName, final String key, final String question) {
        StringRequest rq = new StringRequest(Request.Method.POST, ConstantSet.homeAddress + "main/getguide?", new Response.Listener<String>() {
