...
public class PDFWebViewDialog extends Dialog {
...
//                    guide_iv.setVisibility(View.VISIBLE);
    ...
    public PDFWebViewDialog(Context context, Handler handler, String url, String title, int resid, String thumbPath, DWMediaPlayer player, String action_type) {
