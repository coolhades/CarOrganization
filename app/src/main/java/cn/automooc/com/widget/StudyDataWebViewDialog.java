...
//课程资料预览
public class StudyDataWebViewDialog extends Dialog {
...
//                Toast.makeText(context,webview.getUrl(),Toast.LENGTH_SHORT).show();
    ...
    public StudyDataWebViewDialog(Context context, String url, String title, int resid, String thumbPath, DWMediaPlayer player) {
...
//		FlurryAgent.onStartSession(this, UIApplication.FLURRY_KEY);
    ...
    public void colseDialog() {
        ...
        flag=false;
        StudyDataWebViewDialog.this.dismiss();
        if (player != null) {
            player.start();
        }
    }
...
//        webview.setWebViewClient(wvc);
        ...
        sharedBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    SharedDialog dialog = new SharedDialog(context,"jifen",gurl, mytitle,"");
                ...
                {
                    SharedDialog dialog = new SharedDialog(context,"duihuan",gurl, mytitle,"");
                ...
                {
                    SharedDialog dialog = new SharedDialog(context,"dangan",gurl, mytitle,"");
